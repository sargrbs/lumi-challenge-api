...
describe('Invoice Calculations', () => {
  it('should correctly calculate values', () => {
    ...
    const totalConsumption = sumTotalConsumption(invoiceData.electricityQuantity, invoiceData.energySceeeQuantity);
    const totalWithoutGD = sumTotalWithoutGD(invoiceData.electricityTotal, invoiceData.energySceeeTotal, invoiceData.publicLighting);
