...
describe('PDF Extractor', () => {
    ...
    it('should correctly extract data from a PDF', async () => {
        ...
        expect(extractedData.invoiceDueDate.toISOString().split('T')[0]).toBe('2024-02-04');
        
        expect(extractedData.paymentCode).toBe('83660000001-909480138009-161131014433-608110755504-7');
